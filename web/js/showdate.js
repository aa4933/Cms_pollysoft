...
'#Tools {width:204px;background:#000;padding:0px;}'+
'#Tools li{padding-bottom:1px;}'+
'#Tools a{color:#FFF;}'+
'#Tools a:hover{border:1px solid #09fae9;background:#9d9;}'+
'#Title {width:204px;background:#FFFFFF;border-bottom:1px solid #000;}'+
